...
function Leaderboard() {
  ...
  return <Container sx={{
    ...
    <Stack direction="row" sx={{
      ...
      <Typography variant="h6" onClick={()=> setSelectedBoard(1)}>Monthly</Typography>
      <Typography variant="h6"  onClick={()=> setSelectedBoard(2)}>All Time</Typography>
    </Stack>
    <Stack direction="row" gap={2} justifyContent="center" sx={{
      height: '500px',
    }}>
